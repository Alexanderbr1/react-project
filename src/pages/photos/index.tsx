...
const Photos = () => {
    ...
    const getCameraData = async () => {
        try {
          const response = await axios.get(`https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol=1000&api_key=buVSCf8489W2sQIUrsaOzm8zuR4kh733THuGyaCO`);
