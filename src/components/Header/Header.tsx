...
import { FORM_ROUTE, PDF_ROUTE, PHOTOS_ROUTE, UNIVERSITIES_ROUTE } from "../../app/routing/config.ts";
...
const Header: React.FC<HeaderProps> = ({ isAuthenticated, handleAuthentication }) => {
  return (
      ...
      <HeaderWrapper>
        <div>
          <Flex gap="middle" justify={"center"} align={"center"}>
            ...
            <PrivateRoute path={FORM_ROUTE} name={"Form"} isAuthenticated={isAuthenticated} />
            <Toggle />
